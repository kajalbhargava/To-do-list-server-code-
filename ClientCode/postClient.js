$(document).ready(function(){
  ...
  function sendPost(){
    ...
    todolist.push(task);
    $.post({
      'url':'https://myfinalapptodolist.herokuapp.com/add',
      'data':{'data':task},
  ...
  function display(){
    $.get({
      'url':'https://myfinalapptodolist.herokuapp.com/display',
  ...
  function dell(id){
    console.log(id);
    $.post({
      'url':'https://myfinalapptodolist.herokuapp.com/delete',
      'data':{'data':id},
      success:function(data){
          display();
      }
 ...
 function update(id){
   console.log(id);
   $.post({
     'url':'https://myfinalapptodolist.herokuapp.com/update',
     'data':{'data':id},
     success:function(data){
         display();
         console.log("update");
